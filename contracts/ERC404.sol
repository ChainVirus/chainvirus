...
abstract contract ERC404 is IERC404 {
  ...
  /// @dev MUnits for ERC-20 representation, 10 ** decimals ** mu
  ...
  constructor(string memory name_, string memory symbol_, uint8 mu_) {
    name = name_;
    symbol = symbol_;

    if(mu_ < 0 || mu_ > 18) {
      revert InvalidMUnits();
    }
